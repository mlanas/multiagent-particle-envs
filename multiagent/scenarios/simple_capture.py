...
class Scenario(BaseScenario):
    ...
    def observation(self, agent, world):
        ...
        for entity in world.entities: # agents + landmarks
            ...
            relative_pos = entity.state.p_pos - agent.state.p_pos if entity.state.alive else np.zeros_like(entity.state.p_pos) # the relative position is zero if the entity is dead (death masking)
